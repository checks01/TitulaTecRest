 ...
 * 
 */
@WebServiceClient(name = "EmailService", targetNamespace = "http://servicios.msc.mx.com/", wsdlLocation = "http://localhost:8080/UtilsTecWs/EmailService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMAILSERVICE_QNAME = new QName("http://servicios.msc.mx.com/", "EmailService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/UtilsTecWs/EmailService?wsdl");
    ...
    public EmailService getEmailServicePort() {
        return super.getPort(new QName("http://servicios.msc.mx.com/", "EmailServicePort"), EmailService.class);
    }
    ...
    public EmailService getEmailServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servicios.msc.mx.com/", "EmailServicePort"), EmailService.class, features);
    }
